  ...
  return (
    <section id='hero' className='w-full flex lg:flex-row flex-col justify-between items-start'>
      ...
      <div id='content-section' className='lg:w-[50%] w-full flex flex-col justify-center items-center gap-10 p-20'>
        ...
        <h1 data-aos='zoom-in' data-aos-dealy="400" className='text-[50px] text-black text-center leading-[55px]'>Fresh Breads <br></br>Handcrafted daily</h1>
        <p data-aos='zoom-in' data-aos-dealy="600" className='text-center text-xl text-slate-600'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officia harum eius eligendi, culpa praesentium reprehenderit asperiores repellat! Incidunt, fugiat officia!</p>
